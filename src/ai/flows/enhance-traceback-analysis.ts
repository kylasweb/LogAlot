...
const EnhanceTracebackOutputSchema = z.object({
  analysis: z.string().describe('Enhanced analysis of the traceback.'),
...
const enhanceTracebackPrompt = ai.definePrompt({
  ...
  Analyze the provided traceback to extract the key exception type, relevant frames, and provide an overall analysis of the error.
